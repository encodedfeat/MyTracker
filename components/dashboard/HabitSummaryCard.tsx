...
export function HabitSummaryCard({ name, completedCount, totalDays }: HabitSummaryCardProps) {
    ...
    return (
        <div className="p-6 rounded-lg border border-slate-700/50 bg-black shadow-lg flex flex-col items-center justify-center space-y-4">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="text-sm text-slate-400 mt-1">days completed</span>
            </div>
